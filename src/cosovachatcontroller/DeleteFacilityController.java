...
public class DeleteFacilityController {
    ...
    public DeleteFacilityController(MainView mainView, Client client) {
        this.mainView = mainView;
        this.client = client;
        btnDeletePlayer = mainView.getFunCosoVatchatPanel().getBtnXoa();
        table = mainView.getCosoVatChatPanel().getTable();
        setEvent();
    }
                 ...
                 if (index < 0 ){
                    ...
                    if (select == 0 ){
                        // String ID = String.valueOf(table.getValueAt(index, 0));
                         String ten = String.valueOf(table.getValueAt(index,0));
                         
                         client.getPw().println(ten+":deletecosovatchat");
                         client.getPw().flush();
                    }
