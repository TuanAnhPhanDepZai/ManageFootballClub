...
public class ThongKeView extends JPanel  {
	...
	private String[] columns = { "Nam", "Quy", "Loi nhuận","Gia tri" };
	...
	private JPanel namePanel() {
		...
		//create label
				lbName = new JLabel("Thống kê lợi nhuận");
	...
	public void updateTable(List<LoiNhuan> list){
		...
		for(int i=0;i<list.size();i++){
                        ...
                        LoiNhuan nv = list.get(i);
			data[i][0] = String.valueOf(nv.getNam());
			data[i][1] = String.valueOf(nv.getQuy());
			data[i][2] = nv.getName();
                        data[i][3]= String.valueOf(nv.getGiatri());
		}
